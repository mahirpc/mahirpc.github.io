...
const Contact = () => {
  ...
  return (
    ...
    >
        <h1 className="heading text-3xl">Contact Me</h1>
        <div className="flex flex-col">
          {/* <div className="mt-4 w-64 py-3 pr-3">
            <h2 className="font-semibold text-lg">Muhammed Mahir P C</h2>
            <a href="mailto:mahirpc@duck.com"
            ...
            <div className="flex flex-row flex-wrap mt-1">
              ...
              <a href="https://github.com/mahirpc"
                className="contact-icon"
                target="_blank"
              >
              ...
              <a href="https://linkedin.com/in/muhammed-mahir/"
                className="contact-icon"
                target="_blank"
              >
              ...
              <a href="https://twitter.com/muhammedmahirpc"
                className="contact-icon"
                target="_blank"
              >
              ...
              <a href="https://www.instagram.com/mahir_p_c/"
                className="contact-icon"
                target="_blank"
              >
          ...
          >
            <form className="mt-4 w-full max-w-[350px] md:w-[350] font-mono pr-2" 
              onSubmit={sendMail}>
